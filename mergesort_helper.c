...
extern void *sort_linked_list(void *, unsigned,
  int (*)(void *, void *, void *), void *, unsigned long *);
...
static void free_memory_blocks_helper(struct record_in_memory_helper *first)
{
  while (first != NULL)
  {
...
static int compare_records_helper(void *p, void *q, void *pointer)
{
  #define pp ((struct record_in_memory_helper *) p)
  #define qq ((struct record_in_memory_helper *) q)
